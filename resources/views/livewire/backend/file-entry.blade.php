                        ...
                        <div class="col-sm-4">
                            <div class="search-box mr-2 mb-2 d-inline-block">
                                <div class="position-relative">
                                  <h2 class="font-weight-bold page-header">File</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" wire:click="PersonModal"><i class="mdi mdi-plus mr-1"></i> File</button>
                            </div>
                        </div><!-- end col-->
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var datatable = $('#ClassTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{route('data.file_entry_table')}}",
            columns: [
                {
                    title: 'SL',
                    data: 'id'
