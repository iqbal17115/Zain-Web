    ...
    {{-- <table class="table table-bordered">
        ...
        <tbody>
            ...
            <div class="card card-primary m-2">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('addCategories.submit')}}" method="POST" enctype="multipart/form-data">
                    {{@csrf_field()}}
                    <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <label for="exampleInputEmail1">Capacity (Please Mention Per Day/Week/Month/Year Capacity)</label>
