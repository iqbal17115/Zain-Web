    ...
    {{-- <table class="table table-bordered">
        ...
        <tbody>
            ...
            <div class="card card-primary m-2" >
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('addDepartments.submit')}}" method="POST" enctype="multipart/form-data">
                    {{@csrf_field()}}
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dept_name" class="form-control" id="exampleInputEmail1">
                                @error('news_title')
