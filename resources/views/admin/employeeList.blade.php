                      ...
                      <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>{{$e->departments->dept_name}}</td>
                               
                            <td><a href="{{route('editEmployee',['id'=>$e->employee_id,])}}"><span class="badge bg-warning">Edit</span></a>|<a href="{{route('deleteEmployee',['id'=>$e->employee_id,])}}"><span class="badge bg-danger">Delete</span></td></a>
                          </tr>
